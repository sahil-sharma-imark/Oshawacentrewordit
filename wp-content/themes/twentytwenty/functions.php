...
function contact_form_login_redirect() {
    ...
    <script>
        document.addEventListener( 'wpcf7mailsent', function ( event ) {
			...
			//document.cookie = cookieemail + "=" + email + ";" + expires + ";path=/";

			}

			var value = "success"; 
            location = 'https://oshawacentrewordit.com/game?'+cookieemail+'='+btoa(email);
        }, false );
    </script>
...
function my_setcookie_example(){
	...
	if($currentURL == "https://oshawacentrewordle.customerdevsites.com/game/"){
		$visit_address = $_SERVER['REMOTE_ADDR'];
		$visitor_username = 'visitor_username';
	if(!isset($_COOKIE[$visitor_username])) {
		setcookie($visitor_username, $visit_address, time()+120); // 86400 = 1 day}
