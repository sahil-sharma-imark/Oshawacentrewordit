...
function buildGameCanvas(){
	...
	resultTitleTxt.font = "25px comfortaabold";
...
function changeCanvasViewport(){
	if(canvasContainer!=undefined){
		if(viewport.isLandscape){
			...
			keyboardContainer.x = canvasW/2;
			keyboardContainer.y = canvasH/100 * 88;
...
function createHitarea(obj){
	obj.hitArea = new createjs.Shape(new createjs.Graphics().beginFill("#fff").drawRect(0, 0, obj.image.naturalWidth, obj.image.naturalHeight));	
}